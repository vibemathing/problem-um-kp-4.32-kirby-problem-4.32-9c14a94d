...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-4.32-kirby-problem-4.32-9c14a94d-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-4.32"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-4.32-kirby-problem-4.32-9c14a94d-v1",
      "problem_contract_sha256": "d80746194b7050cda6071df696bebb1bd38ef602ef2467898d7f806f5b93dce0",
      "problem_id": "problem:um-kp-4.32-kirby-problem-4.32-9c14a94d",
      "route_id": "route:um-kp-4.32-kirby-problem-4.32-9c14a94d-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-4.32-kirby-problem-4.32-9c14a94d-source-fidelity-01",
      "graph_id": "graph:um-kp-4.32-kirby-problem-4.32-9c14a94d-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-4.32-kirby-problem-4.32-9c14a94d-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-4.32-kirby-problem-4.32-9c14a94d-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Does there exist a locally flat embedding $f: \\Sigma \\to S^{4}$ for some closed surface $\\Sigma$ such that f is not topologically ambiently isotopic to a smooth embedding? Particularly in the case that $\\Sigma=S^{2}$?"
          },
          "statement_sha256": "570dfb676acc91edd5f78e9879e4cac891eb8ca037be2c33cb7318e1d171ff75"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-4.32-kirby-problem-4.32-9c14a94d-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-4.32-kirby-problem-4.32-9c14a94d-root",
      "route_id": "route:um-kp-4.32-kirby-problem-4.32-9c14a94d-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-4.32-e286222abf3a",
        "url": "https://www.unsolvedmath.com/problems/KP-4.32"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
